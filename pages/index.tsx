...
const Index: React.FC = () => {
  ...
  const tagClick = (
    ...
    switch (tag) {
      case "V1":
        variation(pormpt, msgId, msgHash, 1);
        break;
      case "V2":
        variation(pormpt, msgId, msgHash, 2);
        break;
      case "V3":
        variation(pormpt, msgId, msgHash, 3);
        break;
      case "V4":
        variation(pormpt, msgId, msgHash, 4);
        break;
      case "U1":
        upscale(pormpt, msgId, msgHash, 1);
        break;
      case "U2":
        upscale(pormpt, msgId, msgHash, 2);
        break;
      case "U3":
        upscale(pormpt, msgId, msgHash, 3);
        break;
      case "U4":
        upscale(pormpt, msgId, msgHash, 4);
        break;
      default:
        break;
    }
  };
  const renderMessage = ({ text, img, hasTag, msgHash, msgID }: Message) => {
    return (
      <List.Item
      ...
      >
        ...
        {hasTag && (
          <Tag
            Data={["V1", "V2", "V3", "V4"]}
            onClick={(tag) =>
              tagClick(text, String(msgID), String(msgHash), tag)
            }
          />
        )}
        {hasTag && (
